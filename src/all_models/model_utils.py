...
from src.shared.classes import Corpus, Topic, Document, Mention, EventMention, EntityMention, Cluster
    ...
    for cluster_gold_tag in cluster_gold_tag_set:
        ...
        if isinstance(coref_mentions_1[0], EntityMention):
            if coref_mentions_1[0].mention_type == "HUM":
                ...
                # 生成正例
                th = 50000
                from lib.human_name_tools.name_generator import gen_two_words
                from lib.human_name_tools.str_is_name import word_is_name
