...
def main(args):
    ...
    with open('output/train-srl.pkl', 'wb') as f:
        cPickle.dump(train_set, f)
    with open('output/dev-srl.pkl', 'wb') as f:
        cPickle.dump(dev_set, f)
    with open('output/test-srl.pkl', 'wb') as f:
        cPickle.dump(test_set, f)
    ...
    with open('output/train-dep.pkl', 'wb') as f:
        cPickle.dump(train_set, f)
    with open('output/dev-dep.pkl', 'wb') as f:
        cPickle.dump(dev_set, f)
    with open('output/test-dep.pkl', 'wb') as f:
        cPickle.dump(test_set, f)
    ...
    with open('output/train-lr.pkl', 'wb') as f:
        cPickle.dump(train_set, f)
    with open('output/dev-lr.pkl', 'wb') as f:
        cPickle.dump(dev_set, f)
    with open('output/test-lr.pkl', 'wb') as f:
        cPickle.dump(test_set, f)
    ...
    with open('output/train-elmo.pkl', 'wb') as f:
        cPickle.dump(train_set, f)
    with open('output/dev-elmo.pkl', 'wb') as f:
        cPickle.dump(dev_set, f)
    with open('output/test-elmo.pkl', 'wb') as f:
        cPickle.dump(test_set, f)
